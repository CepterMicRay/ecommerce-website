	                            ...
	                            <div class="row">
	                                ...
	                                <div class="col-md-12 form-group">
	                                    ...
	                                    <select name="payment_method" class="form-control select2" id="advFieldsStatus">
                                            ...
                                            <option value="Mobile Payment"><?php echo LANG_VALUE_164; ?></option>
	                                    </select>
	                                </div>
                                    ...
                                    <form class="paypal" action="<?php echo BASE_URL; ?>payment/paypal/payment_process.php" method="post" id="paypal_form" target="_blank">
                                        ...
                                        <input type="hidden" name="final_total" value="<?php echo $final_total * 0.00106; ?>">
                                        <div class="col-md-12 form-group">
                                        <label><span>For customers located outside of Malawi, we highly recommend using PayPal as your preferred payment method.</span></label><br>
                                    ...
                                    <form action="payment/mobile/init.php" method="post" id="mobile_form">
                                        <input type="hidden" name="amount" value="<?php echo $final_total; ?>">
                                        <div class="col-md-12 form-group">
                                            <label for=""><?php echo LANG_VALUE_43; ?></span></label><br>
                                            <?php
